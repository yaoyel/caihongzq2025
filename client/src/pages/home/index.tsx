...
<span className="text-green-600 font-semibold">"逆袭"</span>未来之路，需要内心的热爱，愿您以高考为起点，<span className="text-green-600 font-semibold">越来越自由自在的心想事成！</span>
</p>
</div>

{/* 操作指引 */}
<div className="bg-gray-50 rounded-xl p-6 shadow-sm border border-gray-100">
<p className="text-lg font-medium mb-4">接下来需要您<span className="text-green-600 font-bold">准备</span>：</p>
<div className="space-y-4">
<p className="text-base leading-relaxed">
1. 预留安静的时间空间：问卷会涉及 168 道题目，请您务必选择 45 分钟左右整段安静的时间来做答。
</p>
<p className="text-base leading-relaxed">
2. 凭<span className="text-green-600 font-bold">第一感觉</span>作答：选择时，无需过多考虑，根据直觉或回顾选择<span className="text-green-600 font-bold">"最像自己"</span>的选项即可。
</p>
</div>
</div>
...
<div className="relative">
<button className="!rounded-button w-full bg-green-500 text-white py-4 px-6 rounded-xl text-lg font-medium shadow-lg hover:bg-green-600 transition-colors duration-300 flex items-center justify-center">
